...
public class ByteUtils {
    ...
    public static short htons(short s){
        short rslt = 0;
        byte [] bs1 = new byte[2];
        ByteUtils.putShort(bs1, s, 0);
        byte[] bs2 = ReversEndian(bs1, 2, false);
        rslt = ByteUtils.getShort(bs2, 0);
        return rslt;
    }
    public static int htonl(int d){
        int rslt = 0;
        byte [] bs1 = new byte[4];
        ByteUtils.putInt(bs1, d, 0);
        byte[] bs2 = ReversEndian(bs1, 4, false);
        rslt = ByteUtils.getInt(bs2, 0);
        return rslt;
    }
    ...
    public static void main(String[] args) {
        ...
        short i = htons(a);
        System.out.println(NumberUtils.getBooleanArray(NumberUtils.shortToRH(a)));
        System.out.println(NumberUtils.getBooleanArray(NumberUtils.shortToRH(i)));
    }
}
